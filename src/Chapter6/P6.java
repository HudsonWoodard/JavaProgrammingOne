...
/**
 * Program to convert a user-inputted dollar amount to various different
 * currencies
 *
...
public class P6 {
    ...
    /**
     * Method to convert dollars to a certain currency
     *
     * @param dollar The dollar amount that was inputted by the user
     * @param currency The user-chosen currency that the method will convert the
     * @return dollar amount to. return total
     */
